...
$id = $_GET['id'];
$result = $conn->query("SELECT * FROM beasiswa WHERE id=$id");
...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $sql = "UPDATE beasiswa SET nim_mahasiswa='$nim_mahasiswa', jenis_beasiswa='$jenis_beasiswa', tanggal_mulai='$tanggal_mulai', tanggal_selesai='$tanggal_selesai' WHERE id=$id";
        ...
        <div class="form-card">
            ...
            <form action="" method="POST">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" id="jenis_beasiswa" name="jenis_beasiswa" value="<?= $data['jenis_beasiswa'] ?>" required>
                </div>
                <div class="mb-3">
